...
class College {
  ...
  display() {
    console.log(
      `College Details:${this.collageName},${this.location},${this.totalBranches},${this.university}`
    );
  }
}
const pote = new College("P.R pote Patil Group", " Amravati", 7, " SGBAU");
pote.display();
const rajiv = new College(
