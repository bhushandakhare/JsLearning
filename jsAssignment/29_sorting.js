console.log(`============================ Assignment Sorting in Ascending & Descending ========================== `);
console.log(`                                                                                           `);
...
class Employee {
    ...
    const arrayEmp = arrayEmployee.sort((emp1, emp2) => {
        return emp1.emp_id > emp2.emp_id ? -1 : 1
        });
        
        arrayEmp.forEach(emp => {
            console.log(`empID: ${emp.emp_id}, Name: ${emp.emp_name}, Department: ${emp.emp_dept}`);
        });
        
        console.log(`                                                                                   `);
        console.log(`==================================================================================================`);
        const arrayDept = arrayEmployee.sort((emp1,emp2)=>{
          return emp1.emp_dept > emp2.emp_dept ? 1 : -1
        });
    
        arrayDept.forEach(emp => {
            console.log(` Department: ${emp.emp_dept},empID: ${emp.emp_id},Company: ${emp.emp_company}`);
        });
